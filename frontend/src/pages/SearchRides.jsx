...
export default function SearchRides() {
  ...
  const handleConfirmBooking = async (selectedSeats) => {
    ...
    try {
      ...
      alert(`Booking request sent successfully! You requested ${selectedSeats} seat${selectedSeats > 1 ? 's' : ''}. The owner will review your request.`);
      ...
      if (errorMessage.includes("seats") || errorMessage.includes("available")) {
        alert(`Booking failed: ${errorMessage}. Please try with fewer seats.`);
      } else {
