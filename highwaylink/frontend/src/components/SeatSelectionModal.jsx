      ...
      <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl relative">
        ...
        <div className="bg-blue-50 rounded-xl p-4 mb-6">
          ...
          <div className="text-sm text-gray-600">
            ...
            <p className="mt-1">{new Date(ride.startTime).toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <input
              ...
              className="w-20 text-center text-3xl font-bold text-blue-600 border-2 border-blue-300 rounded-xl p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              onClick={() => handleSeatSelection(selectedSeats + 1)}
