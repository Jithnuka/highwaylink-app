...
public class RideDTO {
    ...
    private Double ownerRating; // NEW: Driver's average rating
    ...
    public String getOwnerVehicleNumber() {
        return ownerVehicleNumber;
    }

    public void setOwnerVehicleNumber(String ownerVehicleNumber) {
        this.ownerVehicleNumber = ownerVehicleNumber;
    }
    ...
    public void setRequests(java.util.List<String> requests) {
        this.requests = requests;
    }

    public java.util.List<String> getAcceptedPassengers() {
        return acceptedPassengers;
    }

    public void setAcceptedPassengers(java.util.List<String> acceptedPassengers) {
        this.acceptedPassengers = acceptedPassengers;
    }

    public java.util.List<String> getCanceledRequests() {
        return canceledRequests;
    }

    public void setCanceledRequests(java.util.List<String> canceledRequests) {
        this.canceledRequests = canceledRequests;
    }

    public java.util.List<com.highwaylink.model.Booking> getBookings() {
        return bookings;
    }

    public void setBookings(java.util.List<com.highwaylink.model.Booking> bookings) {
