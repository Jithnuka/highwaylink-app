              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`p-2 border-2 rounded-xl transition-all ${role === "PASSENGER"
                  ...
                  <button
                    ...
                    className={`p-2 border-2 rounded-xl transition-all ${role === "OWNER"
                        ? "border-blue-600 bg-blue-50"
                        : "border-gray-200 bg-white hover:border-blue-300"
                      }`}
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`p-3 border-2 rounded-xl transition-all transform hover:scale-105 ${gender === "MALE"
                        ? "border-blue-600 bg-blue-50 shadow-md"
                        : "border-gray-200 bg-white hover:border-blue-300 hover:shadow"
                      }`}
                  >
                    <div className="flex flex-col items-center space-y-2">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${gender === "MALE" ? "bg-blue-100" : "bg-gray-100"
                        }`}>
                      ...
                      <span className={`text-sm font-semibold ${gender === "MALE" ? "text-blue-700" : "text-gray-700"
                        }`}>
                        Male
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className={`p-3 border-2 rounded-xl transition-all transform hover:scale-105 ${gender === "FEMALE"
                        ? "border-pink-600 bg-pink-50 shadow-md"
                        : "border-gray-200 bg-white hover:border-pink-300 hover:shadow"
                      }`}
                  >
                    <div className="flex flex-col items-center space-y-2">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${gender === "FEMALE" ? "bg-pink-100" : "bg-gray-100"
                        }`}>
                        <svg className={`h-6 w-6 ${gender === "FEMALE" ? "text-pink-600" : "text-gray-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <span className={`text-sm font-semibold ${gender === "FEMALE" ? "text-pink-700" : "text-gray-700"
                        }`}>
                        Female
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className={`p-3 border-2 rounded-xl transition-all transform hover:scale-105 ${gender === "OTHER"
                        ? "border-purple-600 bg-purple-50 shadow-md"
                        : "border-gray-200 bg-white hover:border-purple-300 hover:shadow"
                      }`}
                  >
                    <div className="flex flex-col items-center space-y-2">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${gender === "OTHER" ? "bg-purple-100" : "bg-gray-100"
                        }`}>
                        <svg className={`h-6 w-6 ${gender === "OTHER" ? "text-purple-600" : "text-gray-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <span className={`text-sm font-semibold ${gender === "OTHER" ? "text-purple-700" : "text-gray-700"
                        }`}>
                        Other
                      </span>
                    </div>
