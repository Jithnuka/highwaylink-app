            ...
            {inquiries.map((inquiry) => (
              ...
              >
                ...
                <div className="px-6 pb-6">
                  <div
                    className={`flex items-center gap-2 text-sm font-medium ${inquiry.resolved
                        ? "text-green-600"
                        : "text-yellow-600"
                      }`}
                  >
                    <div
                      className={`w-2 h-2 rounded-full ${inquiry.resolved ? "bg-green-500" : "bg-yellow-500 animate-pulse"
                        }`}
                    ></div>
                    <span>
                      {inquiry.resolved
